...
**Java 1.8** must be installed on your machine to run DynamoDB locally. This is the database that our app relies upon. Java can be installed with homebrew, apt-get, or yum. (note Ubuntu 14.0.4
